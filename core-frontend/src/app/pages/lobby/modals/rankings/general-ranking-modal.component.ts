...
@Component({
  selector: 'app-general-ranking-modal',
  templateUrl: './general-ranking-modal.component.html',
  styleUrls: ['./general-ranking-modal.component.scss']
})
export class GeneralRankingModalComponent implements OnInit {
  @Input() stars: any[] = [];
